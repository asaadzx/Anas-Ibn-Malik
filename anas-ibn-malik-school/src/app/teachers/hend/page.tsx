...
const teacherData = {
    ...
    experience: "10 years",
    qualifications: "B.Sc. in Computer Science, M.Ed. in Educational Technology",
    bio: "Dedicated to empowering students with the skills and knowledge to excel in the digital age. Passionate about integrating technology into education.",
    email: "hend.shafik@school.edu",
    phone: "+20 987 654 3210",
    imageUrl: "/images/teachers/hend-shafik.jpg",
    subjects: ["Computer Science", "Programming", "Web Development"],
    achievements: [
        "Developed a school-wide coding curriculum",
        "Mentored students to win national coding competitions",
        "Recognized as Innovator of the Year 2021"
    ]
};
