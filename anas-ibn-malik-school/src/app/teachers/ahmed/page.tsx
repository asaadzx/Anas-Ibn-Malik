...
const teacherData = {
    ...
    experience: "15 years",
    qualifications: "MSc in Mathematics, Certified Math Olympiad Trainer",
    bio: "Dedicated to fostering a love for mathematics in students. Specializes in advanced calculus and problem-solving techniques.",
    email: "ahmed.saeed@school.edu",
    phone: "+20 987 654 3210",
    imageUrl: "/images/teachers/ahmed-saeed.jpg",
    subjects: ["Algebra", "Calculus", "Geometry"],
    achievements: [
        "Math Olympiad Coach for 10 years",
        "Published 5 research papers in mathematics",
        "90% of students achieved A+ in final exams"
    ]
};
