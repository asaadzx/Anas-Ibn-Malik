...
const teacherData = {
    name: "Ms. Ranya Khaled",
    position: "Arabic Teacher",
    experience: "8 years",
    qualifications: "BA in Arabic Language and Literature, Certified Arabic Language Instructor",
    bio: "Dedicated to fostering a love for the Arabic language and culture. Specializes in grammar, poetry, and classical Arabic texts.",
    email: "ranya.khaled@school.edu",
    phone: "+20 987 654 3210",
    imageUrl: "/images/teachers/ranya-khaled.jpg",
    subjects: ["Arabic Grammar", "Classical Arabic", "Arabic Poetry"],
    achievements: [
        "Best Educator Award 2021",
        "Authored 2 books on Arabic grammar",
        "Led students to win regional Arabic poetry competitions"
    ]
};
