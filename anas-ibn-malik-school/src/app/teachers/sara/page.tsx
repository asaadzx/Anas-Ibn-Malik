...
const teacherData = {
  ...
  bio: "Passionate about helping students improve their English skills through interactive learning methods. Specializes in creative writing and literature analysis.",
  email: "sara.ahmed@school.edu",
  phone: "+20 123 456 7890",
  imageUrl: "/images/teachers/sara-ahmed.jpg",
  subjects: ["English Literature", "Creative Writing", "ESL"],
  achievements: [
    "Teacher of the Year 2022",
    "Published 3 educational papers",
    "100% student pass rate in national exams"
  ]
};
